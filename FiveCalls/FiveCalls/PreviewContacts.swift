...
extension Contact {
    ...
    static let governorPreviewContact = Contact(id: "12348", area: "Governor", name: "Govy McGovern", party: "Democrat", phone: "415-555-1212")
    static let agPreviewContact = Contact(id: "12349", area: "AttorneyGeneral", name: "AG McRanOutOfIdeas", party: "Democrat", phone: "415-555-1212")
