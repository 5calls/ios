                ...
                VStack(alignment: .trailing) {
                    HStack {
                        ...
                        if let copiedPhoneNumber {
                            Text(R.string.localizableR.copiedPhone(copiedPhoneNumber))
                                .bold()
                                .font(.footnote)
                                .multilineTextAlignment(.center)
                                .accessibilityFocused($isCopiedPhoneNumberFocused)
                                .accessibilityLabel(R.string.localizableR.a11yCopiedPhoneNumber())
                            Spacer()
                        }
                        ...
                        Text(currentContact.phone)
                            ...
                            .accessibilityHint(R.string.localizableR.a11yPhoneCallCopyHint())
    ...
    var body: some View {
        Button {
            ...
            if dynamicTypeSize >= .accessibility1 {
                Text(R.string.localizableR.a11yOfficeCallPhoneNumber(office.city, office.phone))
            } else {
                Image(systemName: "phone")
                Text(office.city)
            }
        }
        .accessibilityLabel(R.string.localizableR.a11yOfficeCallPhoneNumber(office.city, office.phone))
        .accessibilityHint(R.string.localizableR.a11yPhoneCallHint())
        ...
        if #available(iOS 16.4, *) {
            Button {
                ...
                if dynamicTypeSize >= .accessibility1 {
                    Text(R.string.localizableR.a11yOfficeCopyPhoneNumber(office.city, office.phone))
                } else {
                    Image(systemName: "doc.on.doc")
                    Text(R.string.localizableR.copy())
                }
            }
            .accessibilityLabel(R.string.localizableR.a11yOfficeCopyPhoneNumber(office.city, office.phone))
            .accessibilityHint(R.string.localizableR.a11yPhoneCopyHint())
        }
    }
}
