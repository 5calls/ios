...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/FirebaseAnalytics/Frameworks/FirebaseAnalytics.xcframework" "" "false" "ios-arm64_armv7/FirebaseAnalytics.framework" "ios-arm64_i386_x86_64-simulator/FirebaseAnalytics.framework"
  install_xcframework "${PODS_ROOT}/GoogleAppMeasurement/Frameworks/GoogleAppMeasurementWithoutAdIdSupport.xcframework" "" "false" "ios-arm64_i386_x86_64-simulator/GoogleAppMeasurementWithoutAdIdSupport.framework" "ios-arm64_armv7/GoogleAppMeasurementWithoutAdIdSupport.framework"
fi
